...
def demonstrate_baseline_handling():
    ...
    warming_trajectory = pi_control_temp + 0.01 * (years - 1850) + 0.2 * np.sin(2 * np.pi * (years - 1850) / 20)
    monthly_warming = np.repeat(warming_trajectory, 12) + 0.5 * np.sin(2 * np.pi * np.arange(months) / 12)
