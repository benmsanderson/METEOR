...
ESM_list = ['MPI-ESM1-2-LR']  # test without FAIR scaling, only for this model.
...
#FAIR_subsample.to_pickle(f'../data/FASTMIP_phase2/FAIR_data/subsample_{num_fair}members_{timestamp}.pkl')
...
for esm in ESM_list:
    ...
    for s_idx,scenario in enumerate(scenarios):
        ...
        ensemble_scaled = emulator.generate_ensemble_outputs(
            ...
            save_to=f"{output_dir}METEOR_{esm}_{scenarios_short[s_idx]}_notscaled.nc"
        ) 