...
class TestVariableTransformConfig:
    """Test VariableTransformConfig class."""
    ...
    def test_initialization_none_transform(self):
        """Test initialization with no transform (None)."""
        config = VariableTransformConfig(
            name=None,
            transform_type=None,
            reason='No transform needed'
        )
    ...
    def test_repr_without_transform(self):
...
class TestGetVariableTransformConfig:
    ...
    def test_get_pr_config(self):
        ...
        assert config.transform_type == 'gamma'
        assert 'positive-only' in config.reason.lower() or 'cannot be negative' in config.reason.lower()
    ...
    def test_get_unknown_variable_config(self):
    ...
    def test_get_config_returns_from_registry(self):
    ...
    def test_get_config_creates_new_for_unknown(self):
...
class TestVariableTransformsRegistry:
    ...
    def test_registry_configs_are_instances(self):
...
class TestListAvailableTransforms:
    """Test list_available_transforms() function."""
    
    def test_list_available_transforms_runs(self):
    ...
    def test_list_available_transforms_shows_pr_transform(self):
    ...
    def test_list_available_transforms_shows_tas_none(self):
