...
assert os.path.isfile(
    os.path.join(meteor_root, "default_scm_data", "gases_vupdate_2022_AR6.txt")
)
assert os.path.isfile(
    os.path.join(meteor_root, "default_scm_data", "ssp245_conc_RCMIP.txt")
)
assert os.path.isfile(
    os.path.join(meteor_root, "default_scm_data", "ssp245_em_RCMIP.txt")
)
