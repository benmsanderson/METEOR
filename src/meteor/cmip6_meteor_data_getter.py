...
class Cmip6MeteorDataGetter:  # pylint: disable=too-many-instance-attributes
    ...
    def get_pattern_scaling_cache_path(
        ...
        """
        warnings.warn(
            "Cmip6MeteorDataGetter.get_pattern_scaling_cache_path() is deprecated. "
            "Use meteor.cache_utils.get_pattern_scaling_cache_path() instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from . import cache_utils

        return cache_utils.get_pattern_scaling_cache_path(
            model_name, cache_dir, scenario, variable
        )
    ...
    def validate_pattern_scaling_cache(
        ...
        -------
        tuple
            (is_valid, cached_model, info_dict)
        """
        warnings.warn(
            "Cmip6MeteorDataGetter.validate_pattern_scaling_cache() is deprecated. "
            "Use meteor.cache_utils.validate_pattern_scaling_cache() instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from . import cache_utils

        return cache_utils.validate_pattern_scaling_cache(
            cache_file, model_name, expected_fields=self.flds, scenario=scenario
        )
    ...
    def get_noise_model_cache_path(self, model_name, variable_name, cache_dir=None):
        ...
        """
        warnings.warn(
            "Cmip6MeteorDataGetter.get_noise_model_cache_path() is deprecated. "
            "Use meteor.cache_utils.get_noise_model_cache_path() instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from . import cache_utils

        return cache_utils.get_noise_model_cache_path(
            model_name, variable_name, cache_dir
        )
    ...
    def validate_noise_model_cache(
        ...
        """
        warnings.warn(
            "Cmip6MeteorDataGetter.validate_noise_model_cache() is deprecated. "
            "Use meteor.cache_utils.validate_noise_model_cache() instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from . import cache_utils

        return cache_utils.validate_noise_model_cache(
            cache_file, variable_name, n_modes, lag_order
        )
